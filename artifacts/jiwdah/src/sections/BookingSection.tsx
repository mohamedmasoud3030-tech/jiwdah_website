...
export default function BookingSection() {
  const [formData, setFormData] = useState({ name: "", phone: "", service: "", budget: "" });
            ...
            <AnimatePresence mode="wait">
              {submitted ? (
                ...
                >
                  ...
                  <button onClick={() => setSubmitted(false)} className="btn-outline self-start text-sm py-2.5">
                    طلب جديد
                  </button>
                </motion.div>
              ) : (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5 flex-1 flex flex-col">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div>
                        ...
                        />
                        {phoneError && (
                          <p className="mt-1 flex items-center gap-1 text-red-400/80 text-xs">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="مثال: ٥٠٠ ريال عماني"
                        className={inputClass}
                      />
                    </div>
